...
const helpers = {
  meridian,
  m: meridian,
  ip: (ipAddress, raw = false, city = false) => meridian.ip(ipAddress, raw, city),
...
function startConsole() {
  ...
  console.log('Helpers: ip("8.8.8.8"), ip("8.8.8.8", true), ip("200.160.2.3", false, true), ibge("São Paulo", "SP"), ghsl("São Paulo", "Brazil"), sources(), metadata(), meridian');
